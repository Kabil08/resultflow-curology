...
type ScenarioType = "urgency" | "subscription" | null;
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center p-4 sm:p-6 md:p-8">
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <Card
            className="hover:shadow-2xl transition-all duration-300 cursor-pointer border-2 hover:border-purple-400 bg-white active:scale-95"
          ...
          <Card
            className="hover:shadow-2xl transition-all duration-300 cursor-pointer border-2 hover:border-blue-400 bg-white active:scale-95"
